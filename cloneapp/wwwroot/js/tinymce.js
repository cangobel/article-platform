var articleId = @Model.article.ArticleId;
...
tinymce.init({
	selector: 'textArea',
	plugins: 'save autosave anchor autolink charmap codesample emoticons image link lists media searchreplace table visualblocks wordcount',
